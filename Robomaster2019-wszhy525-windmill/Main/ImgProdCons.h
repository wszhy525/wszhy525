...
#include"./Driver/DHVideoCapture.hpp"
...
private:
    ...
    */
    ...
    /* Camera */
    std::unique_ptr<DHVideoCapture> _videoCapturePtr;
    FrameBuffer _buffer;
    ...
    /*Sentry strategies*/
    std::unique_ptr<Strategies> _sentryStrategiesPtr;

    /*Predictor*/
    std::unique_ptr<Predictor> _predictorPtr;
